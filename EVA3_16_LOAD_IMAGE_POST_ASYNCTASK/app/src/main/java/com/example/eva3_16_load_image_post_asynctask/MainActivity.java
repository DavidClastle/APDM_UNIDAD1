...
public class MainActivity extends AppCompatActivity {
    ...
    private Bitmap download(){
        try {
            InputStream inputStream = (InputStream)new URL("https://static.wikia.nocookie.net/doblaje-fanon/images/a/a7/Hjhjhj.png/revision/latest?cb=20191201130655&path-prefix=es").getContent();
